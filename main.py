...
from trfi_crawler import distrTen, set_running, set_first_run, Bdscomvn, Chotot, \
    ...
    Nhaban, Dothi, Nhadatcanban, Alonhadat, Bdstuanqua, Nhadathay, Muabanchinhchu, Cafeland, Bdscomvi, Muabannhadat, Nhadat24h, \
    Bds24h, Bannhasg, Nhabansg
...
class Ui_MainWindow(QMainWindow):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", f"BDS Crawler 6.2.6{' - %d' % counter if counter else ''}"))
        ...
        self.cbbSite.addItem("Nhadat.cafeland.vn")
        self.cbbSite.addItem("Batdongsan.com.vi")
        self.cbbSite.addItem("Muabannhadat.vn")
        self.cbbSite.addItem("Nhadat24h.net")
        self.cbbSite.addItem("Batdongsan24h.com.vn")
        self.cbbSite.addItem("Bannhasg.com")
        self.cbbSite.addItem("Nhabansg.vn")
    ...
    def onActivated(self, index):
        ...
        if index == 9:
            ...
            self.rdoCustom.setChecked(True)
            self.cbbLoaiTin.setCurrentIndex(0)
            self.cbbProvince.setCurrentIndex(1)
        elif index == 26:
            self.rdoCustom.setChecked(True)
            self.cbbLoaiTin.setCurrentIndex(0)
            self.cbbProvince.setCurrentIndex(1)
    ...
    def start_crawl(self, progress_cb, mess_cb):
        ...
        if _tpage == 'custom':
            ...
            _startp, _endp = self.spinStartPage.value(), self.spinEndPage.value()  # TODO
        ...
        if _site == 1:
            ...
            if _type_ar:
                for type_ in _type_ar:
                    tinbatdongsan = Tinbatdongsan(_provin, type_, progress_cb, mess_cb, start_page=_startp,
            ...
            if _type_ar:
                for type in _type_ar:
                    cafeland = Cafeland(_provin, type, progress_cb, mess_cb, start_page=_startp, end_page=_endp, page=_tpage)
                    rs = cafeland.crawl()
                    self.return_result(rs)
            else:
                cafeland = Cafeland(_provin, _type, progress_cb, mess_cb, start_page=_startp, end_page=_endp,
                                      page=_tpage)
                rs = cafeland.crawl()
                self.return_result(rs)
        elif _site == 21:
            ...
            if _type_ar:
                for type in _type_ar:
                    bdscomvi = Bdscomvi(_provin, type, progress_cb, mess_cb, start_page=_startp, end_page=_endp,
                                                page=_tpage)
                    rs = bdscomvi.crawl()
                    self.return_result(rs)
            else:
                bdscomvi = Bdscomvi(_provin, _type, progress_cb, mess_cb, start_page=_startp, end_page=_endp,
                                    page=_tpage)
                rs = bdscomvi.crawl()
                self.return_result(rs)
            ...
            if _type_ar:
                for type in _type_ar:
                    muabannhadat = Muabannhadat(_provin, type, progress_cb, mess_cb, start_page=_startp, end_page=_endp,
                                                page=_tpage)
                    rs = muabannhadat.crawl()
                    self.return_result(rs)
            else:
                muabannhadat = Muabannhadat(_provin, _type, progress_cb, mess_cb, start_page=_startp, end_page=_endp,
                                            page=_tpage)
                rs = muabannhadat.crawl()
                self.return_result(rs)
        elif _site == 23:
            ...
            if _type_ar:
                for type in _type_ar:
                    nhadat24h = Nhadat24h(_provin, type, progress_cb, mess_cb, start_page=_startp, end_page=_endp,
                                                page=_tpage)
                    rs = nhadat24h.crawl()
                    self.return_result(rs)
            else:
                nhadat24h = Nhadat24h(_provin, _type, progress_cb, mess_cb, start_page=_startp, end_page=_endp,
                                            page=_tpage)
                rs = nhadat24h.crawl()
                self.return_result(rs)
        elif _site == 24:
            ...
            if _type_ar:
                for type in _type_ar:
                    bds24h = Bds24h(_provin, type, progress_cb, mess_cb, start_page=_startp, end_page=_endp,
                                                page=_tpage)
                    rs = bds24h.crawl()
                    self.return_result(rs)
            else:
                bds24h = Bds24h(_provin, _type, progress_cb, mess_cb, start_page=_startp, end_page=_endp,
                                page=_tpage)
                rs = bds24h.crawl()
                self.return_result(rs)
        elif _site == 25:
            _type = 1
            bannhasg = Bannhasg(_provin, _type, progress_cb, mess_cb, start_page=_startp, end_page=_endp,
                                        page=_tpage)
            rs = bannhasg.crawl()
            self.return_result(rs)
            ...
            _type = 1
            nhabansg = Nhabansg(_provin, _type, progress_cb, mess_cb, start_page=_startp, end_page=_endp,
                                        page=_tpage)
            rs = nhabansg.crawl()
            self.return_result(rs)
